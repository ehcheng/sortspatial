...
# Relies on Mike Swanson's Spatial Video Tool executable: https://blog.mikeswanson.com/spatial
...
ACCEPTED_EXTENSIONS = ["mov"]  # List of accepted file extensions without the dot
EXECUTABLE_PATH = "/Users/echeng/bin/spatial"
EXECUTABLE_ARGS = ["info", "--input"]  # Arguments to be passed to the executable
STRING_MATCH_1 = "Has left eye"
STRING_MATCH_2 = "Has right eye"
FILENAME_KEYWORD = "spatial"  # Keyword to check in filename
FILENAME_APPENDIX = "_spatial"  # Text to append if keyword is not present
