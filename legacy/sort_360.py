...
# Relies on ExifTool: https://exiftool.org/install.html
...
ACCEPTED_EXTENSIONS = ["jpg", "heic", "png", "tif", "tiff"]  # List of accepted file extensions without the dot
EXECUTABLE_PATH = "/opt/homebrew/bin/exiftool"
EXECUTABLE_ARGS = []  # Arguments to be passed to the executable
STRING_MATCH_1 = "equirectangular"
STRING_MATCH_2 = "equirectangular"
FILENAME_KEYWORD = "_360"  # Keyword to check in filename
FILENAME_APPENDIX = "_360"  # Text to append if keyword is not present
